...
echo "export LD_LIBRARY_PATH=$"LD_LIBRARY_PATH":/usr/src/tensorrt/samples/python" >> ~/.bashrc
echo "export PYTHONPATH=$"PYTHONPATH":/usr/src/tensorrt/samples/python" >> ~/.bashrc
